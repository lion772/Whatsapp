...
public class Grupo implements Serializable { //Com Serializable, é possível passar dados de uma activity para outra
    ...
    public void salvar(){
        ...
        grupoRef.child( getId() ).setValue(this); //já criado no onCreate do cadastroGrupoActivity.java
        ...
        for ( Usuario membro: getMembros() ){
            ...
            String idDestinatario = getId(); // grupo
