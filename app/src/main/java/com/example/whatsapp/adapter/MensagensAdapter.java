...
public class MensagensAdapter extends RecyclerView.Adapter<MensagensAdapter.MyViewHolder> { //criar o extends, criar MyViewHolder, implementar os métodos, criar um constructor
