...
public class GrupoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Configura adapter
        contatosAdapter = new ContatosAdapter(listaMembros, getApplicationContext()); //Como estamos dentro de uma activity, usaremos o getApplicationContext()

        //Configura recycler para os contatos
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getApplicationContext());
        recyclerMembros.setLayoutManager( layoutManager );
        recyclerMembros.setHasFixedSize( true );
        recyclerMembros.setAdapter( contatosAdapter );

        //Configurar evento de clique no recyclerView para os contatos
        ...
        //Configura recycler para os membros selecionados
        ...
        //Configurar evento de clique no recyclerView para os membros selecionados
